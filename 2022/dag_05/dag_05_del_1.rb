...
def move_box_to_stack(crate_stacks, from, to)
...
def move_multiple_boxes_to_stack(crate_stacks, nbr_boxes, from, to)
    while nbr_boxes > 0
        move_box_to_stack(crate_stacks, from, to)
        nbr_boxes -= 1
    end
    crate_stacks
end
...
for instructions in input
    ...
    move_multiple_boxes_to_stack(crate_stacks, instructions_split[1].to_i, instructions_split[3].to_i, instructions_split[5].to_i)
end
